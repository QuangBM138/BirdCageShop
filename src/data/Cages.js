export const Products_Cage = [
  {
    ...
    price: "74",
    description:
      "About this item Designed for Parakeets, Cockatiels and other small to medium sized birds Features a unique triple roof design Includes 2 plastic cups and 2 wood perches Removable bottom grille and pull out tray for easy cleaning 26-inch long, 14-inch wide, 22-1/2-inch high with 1/2-inch wire spacing",
    size: "Blue & White",
    images:
  ...
  },
  {
    ...
    price: "12",
    description:
      "About this item Naturals toys are handmade from 100-percent natural, sustainable, materials Your bird will benefit from hours of mental stimulation and rugged physical play A variety of natural textures encourages beak exercise Connects to cage easily with quick-link attachment 14-inch long and 5-inch wide",
    size: null,
    images:
  ...
  },
  {
    ...
    price: "79",
    description:
      "About this item Our Clean Life Cockatiel Cage is functional and affordable Integrated seed guard cuts down on mess and debris Removable tray for a cleaner living environment 2 Plastic cups and 2 perches are included 18-Inch Long, 18-inch wide, 24-inch high with 1/2-inch wire spacing",
    size: "Green/White",
    images:
  ...
  },
  {
    ...
    price: "79",
    description:
      "About this item Our Clean Life Playtop Cage is functional and affordable Integrated seed guard cuts down on mess and debris Removable tray for a cleaner living environment 2 plastic cups and 3 perches are included 18-Inch Long, 18-Inch Wide, 27-Inch High with 1/2-Inch wire spacing",
    size: "White",
    images:
  ...
  },
  {
    ...
    price: "12",
    description:
      "Calypso Creations toys satisfy preening urges and discourage plucking Your bird will spend hours shredding, pulling and gnawing on a variety of textures Made from 100-percent safe, non-toxic FD&C colors and materials Connects to cage easily with quick-link attachment 9-inch Long and 6-inch Wide",
    size: null,
    images:
  ...
  },
  {
    ...
    price: "99",
    description:
      "About this item Casbah Parakeet Cage features an elegant curved design Includes 2 plastic hooded cups and 3 wood perches Available in a classic blue and white color combination Designed for Parakeets and other small to medium sized birds 16-1/4-inch long, 14-1/2-inch wide, 32-inch high with 1/2-inch wire spacing",
    size: "Blue/White",
    images:
  ...
  },
  {
    ...
    price: "59",
    description:
      "About this item Color: white Finish: distressed Theme: French Country Material: iron",
    size: '21", 18", 14"H',
    images:
  ...
  },
  {
    ...
    price: "12",
    description:
      "Wrought iron dome top construction offers quality craftsmanship at an affordable price 2 Stainless steel 12 oz. Cups, a wood perch and rounded corner seed Guard set are included Heavy-duty push button door lock plus wind bell lock to keep your bird secure Expertly engineered for easy assembly 18'' long, 18'' wide and 54 5/8'' high with 3/4'' wire spacing",
  ...
  },
  {
    ...
    price: "92",
    description:
      "About this item 2 feeder doors, 2 plastic cups, 2 perches Easy to clean removable metal grate and slide out bottom plastic tray It has a large swing out door with a door pin and small lift up doors Country Of Origin: China",
    size: '18" x 18"',
    images:
  ...
  },
  {
    ...
    price: "35",
    description:
      "About this item A uniquely styled home for your small bird Designed for finches, canaries, parakeets and other small birds Cage includes one branch-shaped perch and two hooded cups Split tray pulls out for convenient cleaning 12 inches in diameter and 21 1/2 inches high to the top of finial",
    size: "Lilac",
    images:
  ...
  },
  {
    ...
    price: "57",
    description:
      "About this item 100% Safe Fd&C Colors Hand Strung Easy To Install Connects To Cage Easily With Quick-Link Attachment",
    size: '18" W x 34" H',
    images:
  ...
  },
  {
    ...
    price: "69",
    description:
      "About this item Designed for Parakeets, Cockatiels and other small birds Includes 2 plastic hooded cups and 2 wood perches Removable bottom grille and pull out tray for convenient cleaning Large, front opening door 26-inch long, 14-inch wide, 20-inch high with 1/2-inch wire spacing",
    size: "Lilac/White",
    images:
  ...
  },
  {
    ...
    price: "30",
    description:
      "About this item Main upward sliding door and two more doors with access to feeding cups Bottom grate and an easy to slide out tray 1/2 inch bar spacing Easy to assemble with clip/hook style lock",
  ...
  },
  {
    ...
    price: "90",
    description:
      "About this item Designed for parrots, cockatiels and other small - medium sized birds Two large front doors for easy access to your bird Decorative double roof design 2 plastic cups and 2 perches are included 16-Inch Long, 14-Inch Wide, 32-Inch High with 1/2-Inch wire spacing",
    size: "Yellow/Black",
    images:
  ...
  },
  {
    ...
    price: "60",
    description:
      'About this item 1/2" bar spacing suitable for small birds Large lift up front door, 2 perches, 2 feeder cups (may be in clear or white), 2 feeder doors, pull out plastic tray for easy cleaning Cage dimension is 24L"x16"Dx16"H Color in White',
  ...
  },
  {
    ...
    price: "65",
    description:
      "About this item 2 feeder doors, 2 cups, 2 perches Easy to clean removable metal grate and slide out bottom plastic tray It has a large swing out door with a door pin and small lift up doors Country Of Origin: China",
    size: '18" x 18"',
    images:
  ...
  },
  {
    ...
    price: "69",
    description:
      "About this item The Square Roof Bird Cage Kit has everything your bird needs Cups, perches, treats and toys are included Ideal cage for small to medium sized birds Made in the USA 16-Inch long, 16-Inch wide, 22-Inch high with 5/8-Inch wire spacing",
    size: null,
    images:
  ...
  },
  {
    ...
    price: "50",
    description:
      "About this item Round Roof Bird Cage Kit has everything your bird needs Cups, perches, treats and toys are included Ideal cage for small sized birds Toys and accessories may vary 13 1/2-Inch long, 11-Inch wide, 16-Inch high with 3/8-Inch wire spacing",
    size: null,
    images:
  ...
  },
  {
    ...
    price: "114",
    description:
      "About this item 4 feeder doors, 4 cups, 4 perches Easy to clean removable metal grate and slide out bottom plastic tray It has a large swing out door with a door pin, and small lift up doors Country Of Origin: China",
  ...
  },
  {
    ...
    price: "94",
    description:
      "About this item The Square Roof Bird Cage Kit has everything your bird needs Cups, perches, treats and toys are included Ideal cage for small to medium sized birds Made in the USA 18-Inch long, 14-Inch wide, 22-Inch high with 5/8-Inch wire spacing",
    size: null,
    images:
  ...
  },
  {
    ...
    price: "165",
    description:
      'Innovative, stackable breeder cage with divider Ideal for multiples of small birds such as canaries, finch and parakeets Quality wrought iron construction with convenient features Four perches and four plastic cups are included Measures 37 1/2" Long, 18" Wide and 20 1/2" High with 1/2" wire spacing Age range description: All Stages',
