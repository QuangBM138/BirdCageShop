  ...
  return (
    <div className="w-full min-h-screen">
      <div className="w-full relative">
        {/* left side */}
        <div className="w-full lg:w-[50%] pt-[30px]">
        ...
        {/* right side */}
        <div className="hidden lg:block absolute right-0 top-0 bg-[#f5f5f5] h-[100vh] overflow-y-scroll w-full lg:w-[50%] pt-[30px] border-cus">
          <List />
        </div>
